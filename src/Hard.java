...
/**
 * 
 * When clicked from difficulty menu it will choose to the Easy class, which has a different difficulty value and will send the "Hard" 
...
public class Hard extends Game {
	 ...
	 * the class, this method is here to give that difficulty. If difficulty is changed from 35 to a different number, then when ever the 
	 * user is playing a Hard level there would be instead of a 35 percent change of mines there would be a newer percentage. This number 
